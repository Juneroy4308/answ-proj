...
) : ICategoryService
{
    ...
    public async Task AddCategoryAsync(CategoryCreateVm category)
    {
        ...
        newCategory.Slug = slugService.GenerateSlug(category.Name + category.TargetGroupId);
    ...
    public async Task UpdateCategoryAsync(CategoryUpdateVm category)
    {
        ...
        if (editedCategory != null)
        {
            ...
            editedCategory.Slug = slugService.GenerateSlug(category.Name + category.TargetGroupId);
