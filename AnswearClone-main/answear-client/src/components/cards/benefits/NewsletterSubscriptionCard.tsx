...
const NewsletterSubscriptionCard: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex-col py-6 pr-4 lg:px-24 bg-gray-100 lg:w-1/2">
            ...
            <div className="flex flex-col items-start ml-4 mt-8 lg:space-x-4 lg:flex-row">
                <div className="w-full max-w-[400px] pr-24 lg:pr-0">
                    <InputEmail
                ...
                <Button className="max-w-[200px] mt-4 lg:mt-0" type="submit">
                    Підписатися
                </Button>
            </div>
        </form>
